...
declare global {
  interface HTMLElementTagNameMap {
    [TurtleInfoIcon.defaultTagName]: TurtleInfoIcon;
  }
}

/**
 * @element turtle-info-icon
 */
export class TurtleInfoIcon extends LitElement {
  static defaultTagName = "turtle-info-icon" as const;
