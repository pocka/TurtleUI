...
declare global {
  interface HTMLElementTagNameMap {
    [TurtleBrandIcon.defaultTagName]: TurtleBrandIcon;
  }
}

/**
 * @element turtle-brand-icon
 */
export class TurtleBrandIcon extends LitElement {
  static defaultTagName = "turtle-brand-icon" as const;
